...
// TODO: I think drop can still stack overflow when the recursive type is nested in a non-optional field
// TODO: I also think, drop straight up shouldn't compile for enum nodes?
